            ...
            <CarouselContent className="-ml-1">
              {isLoadingBrands ? (
                Array.from({ length: 5 }).map((_, index) => (
                  <CarouselItem key={index} className="basis-1/5 pl-1" style={{paddingLeft: '5px', paddingRight: '5px'}}>
                ...
                brands?.map((brand) => (
                  <CarouselItem key={brand.id} className="basis-1/5 pl-1" style={{paddingLeft: '5px', paddingRight: '5px'}}>
