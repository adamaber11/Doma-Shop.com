  ...
  async function onSubmit(values: z.infer<typeof categorySchema>) {
    ...
    try {
      ...
      toast({
        ...
        description: `تمت إضافة فئة "${values.name}" إلى المتجر.`,
      });
      form.reset();
    } catch (error) {
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>
            املأ النموذج أدناه لإضافة فئة جديدة. يمكنك تحديد فئة رئيسية لجعلها فئة فرعية.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="مثال: ملابس رجالية" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
